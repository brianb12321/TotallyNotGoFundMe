    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form-group">
                ...
                <asp:RangeValidator runat="server" Display="Dynamic" ControlToValidate="pledgeAmountTextBox" MinimumValue="1" MaximumValue="100000" CssClass="text-danger" Type="Integer" ErrorMessage="Pledge amount must be between $1 to $100,000"></asp:RangeValidator>
            </div>
